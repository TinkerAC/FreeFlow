...
在接口保护方面，像上传、发行、购买以及评论这些链下接口，全都要求进行会话认证，并且借助服务端来统一维护用户身份、上传记录还有交易投影。目前系统里的音频资源，依然是基于 CID 还有网关来进行访问的，如果资源地址被直接获取，仍有可能绕过应用这边的访问流程。已经有研究也表明了，在区块链和 IPFS 相结合的数据共享场景当中，链上的访问授权通常还是需要配合链下的加密、密钥管理或者是受控解密流程，才可以更加完整地约束实际的资源访问\cite{Ali2017IoTIPFS,Qin2021BlockchainAccess}。所以，现阶段的访问控制，更加适宜当作原型系统里的授权验证机制，后续还是需要结合音频加密、授权网关或者短期签名URL等方案，来进一步完善资源保护方面的能力。
