...
export const ServiceSettings = z.object({
  ...
  web3Publishing: z.object({
    ...
    chainName: z.string().default('Sepolia'),
    rpcUrl: z.string().default('https://ethereum-sepolia-rpc.publicnode.com'),
    musicAssetAddress: z.string().default(''),
    royaltySplitterFactoryAddress: z.string().default(''),
    platformHubAddress: z.string().default(''),
    defaultRoyaltyBps: z.number().int().min(0).max(10000).default(1000),
  }).default({
    chainId: 11155111,
    chainName: 'Sepolia',
