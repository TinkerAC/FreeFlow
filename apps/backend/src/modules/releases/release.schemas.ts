...
export const UpdateCreatorReleaseSchema = z.object({
  ...
  audioCid: z.string().trim().max(255).optional().nullable(),
  audioGatewayUrl: z.string().trim().url().max(4096).optional().nullable(),
  coverCid: z.string().trim().max(255).optional().nullable(),
  coverGatewayUrl: z.string().trim().url().max(4096).optional().nullable(),
  metadataCid: z.string().trim().max(255).optional().nullable(),
  metadataUri: z.string().trim().max(4096).optional().nullable(),
  metadataGatewayUrl: z.string().trim().url().max(4096).optional().nullable(),
