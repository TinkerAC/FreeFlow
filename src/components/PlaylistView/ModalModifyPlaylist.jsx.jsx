...
const ModalModifyPlaylist = ({
    ...
    const handleSubmit = async (e) => {
        ...
        // 调用 API 更新歌单信息
        await window.electronAPI.modifyPlaylist(playListInfo.playlist_id, title, description, refreshPlaylist);
        onClose();
    };
